...
@Component({
  selector: 'app-reports-sgp-budget',
  standalone: true,
  imports: [
    CommonModule,
    MatSelectModule,
  ...
  templateUrl: './reports-sgp-budget.component.html',
  styleUrl: './reports-sgp-budget.component.scss',
})
export class ReportsSgpBudgetComponent implements OnInit {
